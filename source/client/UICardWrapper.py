...
class UICardWrapper:
    ...
    def __init__(self, this_card, loc_xy, current_scale):
        self.card = this_card
        self.img = UICardWrapper.getImage(self.card, current_scale)
    ...
    def getImage(card, card_scale):
        ...
        img = pygame.transform.rotozoom(img, 0, card_scale)
        return img
